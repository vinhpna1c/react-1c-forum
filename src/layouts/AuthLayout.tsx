    ...
    return (
        <div className="grid grid-cols-2" style={{
            ...
            < div className="flex flex-col col-span-1 px-24 py-10">
                <Link to={'/'}>
                    <Image width={108} height={108} alt="1C_logo" src='/images/1C_Innovation_logo.png' />
                </Link>

                <h4 className="text-white text-[15px] font-semibold">1C: Diễn đàn</h4>
                <h1 className="text-gray-300 text-4xl font-medium">Nơi mọi người kết nối và chia sẻ mọi điều trong cuộc sống</h1>
                <div className="flex flex-col w-[450px] my-40 bg-[#202433] py-8 px-10 rounded-lg" style={{ boxShadow: '10px 10px 0px 0px rgba(32, 36, 51, 0.35)' }}>
